...
d.out<-read.csv("AgeIP2.csv",header=TRUE)
d.out2 <- d.out %>%
...
#We use d.in0 for region chart and d.out0 for age chart
```


```{r}
###Table 1
#Organize variable type
d.in0 <- d.in0 %>%
...
## Multiple regression on the ratio:

```{r}
### multiple regression on I - region
